...
<div class="row justify-content-center">
    ...
    <div class="col-3">
        ...
        <a href="/rest/questions/deletecandidate/${candidate.candidate_id}" class="btn btn-primary" style="margin-bottom:50px;margin-left:50px; color:rgb(245, 51, 51)" onClick="success(event)">DELETE</a>
    </div>
