            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="col-1"><a href="/rest/questions/showquestion/${ques.question_id}" style="color: #3A6DF2">Edit</a></div><div class="col-1"><a href="/rest/questions/deletequestion/${ques.question_id}" style="color: rgb(255, 0, 0)">Delete</a></div>
                        </div>
                    </td>
